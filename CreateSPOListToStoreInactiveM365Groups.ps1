...
$item = Add-PnPField -List $SharePointListName -DisplayName "Approved to Archive" -InternalName "ApprovedToArchive" -Type Text -AddToDefaultView -Connection $RootConnection
